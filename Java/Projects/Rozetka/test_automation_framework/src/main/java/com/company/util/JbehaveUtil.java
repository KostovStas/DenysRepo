...
public class JbehaveUtil {
    ...
    private static <T> List<T> populate(final ExamplesTable table, final Class<T> returnType,
    ...
    private static <T> T populate(final Parameters row, final Class<T> returnType) {
